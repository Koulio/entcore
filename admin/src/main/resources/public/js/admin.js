...
/***/ function(module, exports, __webpack_require__) {
	...
	var components_1 = __webpack_require__(69);
	var routing_1 = __webpack_require__(429);
	var services_1 = __webpack_require__(125);
	...
	AdminModule = __decorate([
	    core_1.NgModule({
	        ...
	        declarations: [
	            components_1.AdminRoot,
	            components_1.Portal,
	            components_1.Home,
	            components_1.UsersRoot,
	            components_1.UserList,
	            components_1.UserDetail,
	            components_1.UserFilters,
	            components_1.UserCreate,
	            components_1.UserError,
	            components_1.StructureHome,
	            components_1.SideLayout,
	            components_1.ListComponent,
	            components_1.SpinnerComponent,
	            components_1.PanelSection,
	            components_1.FormField
	        ],
	        providers: [
	            routing_1.UsersResolve,
	            routing_1.SessionResolve,
	            routing_1.StructuresResolve,
	            routing_1.StructureResolve,
	            routing_1.I18nResolve,
	            services_1.LoadingService,
	            services_1.SijilLabelsService
	        ],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Portal = (function () {
	    ...
	    Portal.prototype.ngOnInit = function () {
	        ...
	        var initialStructureId = this.route.snapshot.params['structureId'];
	        this.structures = models_1.structures.asTree();
	        if (initialStructureId)
	            this.currentStructure = models_1.structures.data.find(function (s) { return s.id === initialStructureId; });
	    };
	    return Portal;
	}());
	__decorate([
	...
	Portal = __decorate([
	    core_1.Component({
	        ...
	        templateUrl: __webpack_require__(119),
	        changeDetection: core_1.ChangeDetectionStrategy.OnPush
	    }),
	    __metadata("design:paramtypes", [core_1.ChangeDetectorRef,
	        router_1.Router,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var structure_1 = __webpack_require__(102);
	...
	exports.structures = new StructureCollection();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serializable_1 = __webpack_require__(118);
	var Structure = (function (_super) {
	    __extends(Structure, _super);
	    function Structure() {
	        var _this = _super.call(this) || this;
	        _this._json_fields = ['UAI', 'externalId', 'name'];
	        _this.users = new user_collection_1.UserCollection();
	        return _this;
	    }
	    Object.defineProperty(Structure.prototype, "id", {
...
/***/ function(module, exports) {
	...
	var Serializable = (function () {
	    ...
	    Serializable.prototype.toJSON = function () {
	        var json = {};
	        for (var i = 0; i < this._json_fields.length; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StructureHome = (function () {
	    function StructureHome(route, cdRef) {
	        this.route = route;
	        this.cdRef = cdRef;
	        this.structures = models_1.structures;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(22);
	var services_1 = __webpack_require__(125);
	var user_list_component_1 = __webpack_require__(413);
	var UsersRoot = (function () {
	    ...
	    UsersRoot.prototype.ngOnInit = function () {
	        ...
	        this.structureSubscriber = this.route.parent.data.subscribe(function (data) {
	            var currentStructure = data['structure'];
	            if (currentStructure.users.data.length > 0) {
	                _this.userlist = currentStructure.users.data;
	            }
	            else {
	                _this.loadingService.load('portal-content');
	                currentStructure.users.sync().then(function () {
	                    _this.userlist = currentStructure.users.data;
	                }).catch(function (e) {
	                    _this.onError(e);
	                }).then(function () {
	        ...
	        // Watch selected user
	        this.userSubscriber = this.route.queryParams.subscribe(function (params) {
	            if (params['userId']) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var rxjs_1 = __webpack_require__(127);
	var LoadingService = (function () {
	    ...
	    LoadingService.prototype.isLoading = function (something) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var mappings_1 = __webpack_require__(414);
	var dist_1 = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserDetail = (function () {
	    function UserDetail(loadingService) {
	        this.loadingService = loadingService;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(2);
	var loading_service_1 = __webpack_require__(126);
...
/***/ function(module, exports, __webpack_require__) {
	...
	], SideLayout.prototype, "hideCompanion", void 0);
	__decorate([
...
/***/ function(module, exports, __webpack_require__) {
	...
	ListComponent = __decorate([
	    core_1.Component({
	        ...
	        templateUrl: __webpack_require__(426),
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var i18n_resolve_1 = __webpack_require__(431);
	var structures_resolve_1 = __webpack_require__(432);
	var structure_resolve_1 = __webpack_require__(433);
	var session_resolve_1 = __webpack_require__(434);
	var users_resolve_1 = __webpack_require__(435);
	var components_1 = __webpack_require__(69);
	exports.routes = [
	    {
	        path: '',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StructuresResolve = (function () {
	    ...
	    StructuresResolve.prototype.resolve = function () {
	        return models_1.structures.sync();
	    };
	...
	var StructureResolve = (function () {
	    ...
	    StructureResolve.prototype.resolve = function (route) {
	        return new Promise(function (res, rej) {
	            var target = models_1.structures.data.find(function (s) { return s.id === route.params['structureId']; });
	            if (target) {
	                res(target);
	            }
	            else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersResolve = (function () {
	    ...
	    UsersResolve.prototype.resolve = function (route) {
	        var _this = this;
	        var currentStructure = models_1.structures.data.find(function (s) { return s.id === route.parent.params['structureId']; });
	        if (currentStructure.users.data.length > 0) {
